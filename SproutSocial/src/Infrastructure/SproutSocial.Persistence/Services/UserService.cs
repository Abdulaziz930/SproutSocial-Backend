...
public class UserService : IUserService
{
    ...
    public async Task<bool> FollowRequestAsync(string userId)
    {
        ...
        var currentDbUser = await _userManager.FindByNameAsync(currentUser.Name);
        ...
        user.FollowRequestsMade ??= new List<UserFollow>();
        user.FollowRequestsMade.Add(new()
        {
            FollowingUserId = user.Id,
            FollowerUserId = currentDbUser.Id
        });
    ...
    public Task<bool> UnFollowAsync(string userId)
    {
        throw new NotImplementedException();
    }

    public async Task<bool> AcceptOrDeclineFollowRequestAsync(bool acceptOrDeclineFollowRequest, string userFollowId)
    {
        ArgumentNullException.ThrowIfNull(userFollowId);
